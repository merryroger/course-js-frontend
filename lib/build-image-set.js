...
export default function buildImageSet(params, image_set) {
  let { label = '', key, id, className = null } = params;
  ...
  let controls = `<div class="image__load__controls"><button type="button" class="image__load__button formatted__width">Upload</button></div>`;
