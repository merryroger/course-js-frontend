export default function buildNumberField(params, value) {
  ...
  return `<div class="elem__${key}">${label_tag}<input type="number" ${_id}name="${key}" value="${value}"${tag_size}${cName}${tindex}${pholder}${req}${afoc} /></div>`;
}
